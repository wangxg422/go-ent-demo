...
const (
	...
	// SysRolesTable is the table that holds the sys_roles relation/edge. The primary key declared below.
...
var (
	...
	// primary key for the sys_roles relation (M2M).
...
// BySysRolesCount orders the results by sys_roles count.
...
// BySysRoles orders the results by sys_roles terms.
