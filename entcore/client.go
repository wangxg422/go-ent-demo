...
var ErrTxStarted = errors.New("entcore: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("entcore: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entcore: unknown mutation type %T", m)
	}
}
...
func (c *SysDeptClient) UpdateOneID(id types.ID) *SysDeptUpdateOne {
...
func (c *SysDeptClient) DeleteOneID(id types.ID) *SysDeptDeleteOne {
...
func (c *SysDeptClient) Get(ctx context.Context, id types.ID) (*SysDept, error) {
	return c.Query().Where(sysdept.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SysDeptClient) GetX(ctx context.Context, id types.ID) *SysDept {
...
func (c *SysDeptClient) QuerySysRoles(_m *SysDept) *SysRoleQuery {
...
func (c *SysDeptClient) QueryParent(_m *SysDept) *SysDeptQuery {
...
// QueryChildren queries the children edge of a SysDept.
func (c *SysDeptClient) QueryChildren(_m *SysDept) *SysDeptQuery {
	query := (&SysDeptClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(sysdept.Table, sysdept.FieldID, id),
			sqlgraph.To(sysdept.Table, sysdept.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, sysdept.ChildrenTable, sysdept.ChildrenColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *SysDeptClient) mutate(ctx context.Context, m *SysDeptMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entcore: unknown SysDept mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *SysMenuClient) UpdateOneID(id types.ID) *SysMenuUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SysMenuClient) DeleteOneID(id types.ID) *SysMenuDeleteOne {
...
func (c *SysMenuClient) Get(ctx context.Context, id types.ID) (*SysMenu, error) {
	return c.Query().Where(sysmenu.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SysMenuClient) GetX(ctx context.Context, id types.ID) *SysMenu {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *SysMenuClient) QuerySysRoles(_m *SysMenu) *SysRoleQuery {
	query := (&SysRoleClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *SysMenuClient) mutate(ctx context.Context, m *SysMenuMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entcore: unknown SysMenu mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *SysRoleClient) UpdateOneID(id types.ID) *SysRoleUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SysRoleClient) DeleteOneID(id types.ID) *SysRoleDeleteOne {
...
func (c *SysRoleClient) Get(ctx context.Context, id types.ID) (*SysRole, error) {
	return c.Query().Where(sysrole.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SysRoleClient) GetX(ctx context.Context, id types.ID) *SysRole {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *SysRoleClient) QuerySysDepts(_m *SysRole) *SysDeptQuery {
	query := (&SysDeptClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *SysRoleClient) QuerySysMenus(_m *SysRole) *SysMenuQuery {
	query := (&SysMenuClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *SysRoleClient) mutate(ctx context.Context, m *SysRoleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entcore: unknown SysRole mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *SysUserClient) UpdateOneID(id types.ID) *SysUserUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SysUserClient) DeleteOneID(id types.ID) *SysUserDeleteOne {
...
func (c *SysUserClient) Get(ctx context.Context, id types.ID) (*SysUser, error) {
	return c.Query().Where(sysuser.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SysUserClient) GetX(ctx context.Context, id types.ID) *SysUser {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *SysUserClient) mutate(ctx context.Context, m *SysUserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entcore: unknown SysUser mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		SysDept, SysMenu, SysRole, SysUser []ent.Hook
	}
	inters struct {
		SysDept, SysMenu, SysRole, SysUser []ent.Interceptor
	}
)
