...
func (_q *SysDeptQuery) QuerySysRoles() *SysRoleQuery {
...
func (_q *SysDeptQuery) QueryParent() *SysDeptQuery {
...
func (_q *SysDeptQuery) QueryChildren() *SysDeptQuery {
	query := (&SysDeptClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *SysDeptQuery) FirstID(ctx context.Context) (id types.ID, err error) {
	var ids []types.ID
...
func (_q *SysDeptQuery) FirstIDX(ctx context.Context) types.ID {
...
func (_q *SysDeptQuery) OnlyID(ctx context.Context) (id types.ID, err error) {
	var ids []types.ID
...
func (_q *SysDeptQuery) OnlyIDX(ctx context.Context) types.ID {
...
func (_q *SysDeptQuery) IDs(ctx context.Context) (ids []types.ID, err error) {
...
func (_q *SysDeptQuery) IDsX(ctx context.Context) []types.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SysDeptQuery) WithSysRoles(opts ...func(*SysRoleQuery)) *SysDeptQuery {
	query := (&SysRoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SysDeptQuery) WithParent(opts ...func(*SysDeptQuery)) *SysDeptQuery {
	query := (&SysDeptClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SysDeptQuery) WithChildren(opts ...func(*SysDeptQuery)) *SysDeptQuery {
	query := (&SysDeptClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SysDeptQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SysDept, error) {
	...
	if query := _q.withParent; query != nil {
		if err := _q.loadParent(ctx, query, nodes, nil,
			func(n *SysDept, e *SysDept) { n.Edges.Parent = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withChildren; query != nil {
		if err := _q.loadChildren(ctx, query, nodes,
			func(n *SysDept) { n.Edges.Children = []*SysDept{} },
			func(n *SysDept, e *SysDept) { n.Edges.Children = append(n.Edges.Children, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SysDeptQuery) loadSysUsers(ctx context.Context, query *SysUserQuery, nodes []*SysDept, init func(*SysDept), assign func(*SysDept, *SysUser)) error {
	...
	nodeids := make(map[types.ID]*SysDept)
	for i := range nodes {
...
func (_q *SysDeptQuery) loadSysRoles(ctx context.Context, query *SysRoleQuery, nodes []*SysDept, init func(*SysDept), assign func(*SysDept, *SysRole)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[types.ID]*SysDept)
	nids := make(map[types.ID]map[*SysDept]struct{})
...
func (_q *SysDeptQuery) loadParent(ctx context.Context, query *SysDeptQuery, nodes []*SysDept, init func(*SysDept), assign func(*SysDept, *SysDept)) error {
...
func (_q *SysDeptQuery) loadChildren(ctx context.Context, query *SysDeptQuery, nodes []*SysDept, init func(*SysDept), assign func(*SysDept, *SysDept)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[types.ID]*SysDept)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(sysdept.FieldParentID)
	}
	query.Where(predicate.SysDept(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(sysdept.ChildrenColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *SysDeptQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withParent != nil {
			_spec.Node.AddColumnOnce(sysdept.FieldParentID)
		}
	}
